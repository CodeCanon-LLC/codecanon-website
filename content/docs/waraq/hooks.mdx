...
Returns document-level state: canvas dimensions, background color, zoom, and panel visibility. Use this when your component only cares about viewport or canvas-level properties.
